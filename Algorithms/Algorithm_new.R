...
phiset.trim <- phiset[which(sapply(1:1000, function(i){max(phiset[i,]) < .95})==TRUE),]
ones <- phiset[which(sapply(1:1000, function(i){max(phiset[i,]) >= .95})==TRUE),]
i.ones <- which(sapply(1:1000, function(i){max(phiset[i,]) >= .95})==TRUE)
